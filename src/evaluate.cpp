...
template Value Eval::evaluate<CHESS_VARIANT, true >(const Position&);
template Value Eval::evaluate<CHESS_VARIANT, false>(const Position&);
#ifdef ANTI
template Value Eval::evaluate<ANTI_VARIANT, true >(const Position&);
template Value Eval::evaluate<ANTI_VARIANT, false>(const Position&);
#endif
#ifdef ATOMIC
template Value Eval::evaluate<ATOMIC_VARIANT, true >(const Position&);
template Value Eval::evaluate<ATOMIC_VARIANT, false>(const Position&);
#endif
#ifdef CRAZYHOUSE
template Value Eval::evaluate<CRAZYHOUSE_VARIANT, true >(const Position&);
template Value Eval::evaluate<CRAZYHOUSE_VARIANT, false>(const Position&);
#endif
#ifdef HORDE
template Value Eval::evaluate<HORDE_VARIANT, true >(const Position&);
template Value Eval::evaluate<HORDE_VARIANT, false>(const Position&);
#endif
#ifdef KOTH
template Value Eval::evaluate<KOTH_VARIANT, true >(const Position&);
template Value Eval::evaluate<KOTH_VARIANT, false>(const Position&);
#endif
#ifdef LOSERS
template Value Eval::evaluate<LOSERS_VARIANT, true >(const Position&);
template Value Eval::evaluate<LOSERS_VARIANT, false>(const Position&);
#endif
#ifdef RACE
template Value Eval::evaluate<RACE_VARIANT, true >(const Position&);
template Value Eval::evaluate<RACE_VARIANT, false>(const Position&);
#endif
#ifdef RELAY
template Value Eval::evaluate<RELAY_VARIANT, true >(const Position&);
template Value Eval::evaluate<RELAY_VARIANT, false>(const Position&);
#endif
#ifdef THREECHECK
template Value Eval::evaluate<THREECHECK_VARIANT, true >(const Position&);
template Value Eval::evaluate<THREECHECK_VARIANT, false>(const Position&);
#endif
...
#ifdef ANTI
  case ANTI_VARIANT:
      v = evaluate<ANTI_VARIANT, true>(pos);
      break;
#endif
#ifdef ATOMIC
  case ATOMIC_VARIANT:
      v = evaluate<ATOMIC_VARIANT, true>(pos);
      break;
#endif
#ifdef CRAZYHOUSE
  case CRAZYHOUSE_VARIANT:
      v = evaluate<CRAZYHOUSE_VARIANT, true>(pos);
      break;
#endif
#ifdef HORDE
  case HORDE_VARIANT:
      v = evaluate<HORDE_VARIANT, true>(pos);
      break;
#endif
#ifdef KOTH
  case KOTH_VARIANT:
      v = evaluate<KOTH_VARIANT, true>(pos);
      break;
#endif
#ifdef LOSERS
  case LOSERS_VARIANT:
      v = evaluate<LOSERS_VARIANT, true>(pos);
      break;
#endif
#ifdef RACE
  case RACE_VARIANT:
      v = evaluate<RACE_VARIANT, true>(pos);
      break;
#endif
#ifdef RELAY
  case RELAY_VARIANT:
      v = evaluate<RELAY_VARIANT, true>(pos);
      break;
#endif
#ifdef THREECHECK
  case THREECHECK_VARIANT:
      v = evaluate<THREECHECK_VARIANT, true>(pos);
      break;
#endif
  default:
      v = evaluate<CHESS_VARIANT, true>(pos);
  }
